...
public class ChatActivity extends AppCompatActivity {
    ...
    void callApi(JSONObject jsonObject) {
        MediaType JSON = MediaType.get("application/json");  //some line include in video
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization", "Bearer AAAA504Jqio:APA91bGrRSoO9Hb2LfkYdohpEx082maR7XbdQTX87FN1hccQpxMlsiwTkejLGIQIXQrbwX4KfRXYt2qXErfT3a8lgwGsHZYlGWBuB2RT60uD74lx2i5dXT8p0-4kasAPprqn1MbLQZh0")
                .build();
